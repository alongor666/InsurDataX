...
*   场景一：日常业务监控与周报生成
    ...
    *   他使用业务类型筛选器进行选择。筛选器顶部提供“全选”、“反选”、“清除”操作；中间列出所有业务类型，每项前有复选框，旁边有“仅选此项”按钮；底部有“确认”和“取消”按钮。“全选”、“反选”和复选框勾选需要点击“确认”生效，“清除”和“仅选此项”立即生效。
...
*   F-CTRL-003: 业务类型筛选 (已增强)
    *   **下拉菜单布局**:
        *   **顶部操作区**: 提供“全选”、“反选”、“清除”操作。
        *   **中间列表区**: 列出所有业务类型，每项前有复选框，旁边有“仅选此项”按钮。
        *   **底部确认区**: 提供“确认”和“取消”按钮。
    *   **确认逻辑**:
        *   **立即生效**: “清除”操作、“仅选此项”操作。
...
| :--- | :--------- | :------- | :------------------------------------- |
| ...  | ...        | ...      | ...                                    |
| 2.8  | 2024-05-28 | AI项目大师 | 1. 修正KPI卡片箭头方向逻辑。2. 全局规则：视觉层禁止英文；AI分析使用富文本，禁止用颜色描述问题，改用指标状态，并强调全中文。3. 业务类型筛选器增强：为每项增加“只选此项”和“勾选所有其他项”的子菜单功能。4. 压缩KPI看板尺寸，调整卡片内部布局。 |
