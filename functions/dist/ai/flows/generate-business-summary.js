...
const GenerateBusinessSummaryInputSchema = genkit_2.z.object({
    data: genkit_2.z.string().describe('The data to analyze, in JSON format. This includes keyPerformanceIndicators (KPIs) and topBusinessLinesByPremiumWritten.'),
    filters: genkit_2.z.string().describe('The filters applied to the data, in JSON format. This includes analysisMode, period, comparison period info, selectedBusinessTypes, and vcrColorRules (which explains how variable_cost_ratio maps to colors and business implications like "经营优秀/低风险", "健康/中等风险", "警告/高风险").'),
});
const GenerateBusinessSummaryOutputSchema = genkit_2.z.object({
    summary: genkit_2.z.string().describe('A structured and concise summary of business performance highlights, potential risks, and actionable insights, in Chinese. The summary should be tailored to the provided data and filters, reflecting a deep understanding of car insurance business dynamics.'),
});
async function generateBusinessSummary(input) {
...
const generateBusinessSummaryFlow = genkit_1.ai.defineFlow({
...
//# sourceMappingURL=generate-business-summary.js.map