...
const GenerateShareChartAnalysisOutputSchema = z.object({
  summary: z.string().describe('A structured and concise analysis of the share chart in Chinese, using Markdown for emphasis. It should identify dominant business lines, assess their contribution quality based on variable_cost_ratio business status, and highlight potential structural insights or imbalances.'),
});
